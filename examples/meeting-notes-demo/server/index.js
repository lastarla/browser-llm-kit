...
const DEFAULT_DIST_WEB_DIR = new URL('../../../dist/examples/meeting-notes-demo/web/', import.meta.url);
const DEFAULT_SOURCE_WEB_DIR = new URL('../web/', import.meta.url);
...
export function createRequestHandler(options = {}) {
  const distFrontDir = options.distFrontDir ?? DEFAULT_DIST_WEB_DIR;
  const sourceFrontDir = options.sourceFrontDir ?? DEFAULT_SOURCE_WEB_DIR;
